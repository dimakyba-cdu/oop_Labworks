...
internal class Program
{
  ...
  {
    Console.WriteLine("Enter the array into single line with spaces within:");
    ...
    Console.WriteLine($"LINQ: {string.Join(", ", FilterUsingLinq(arr, filterMultiple))}");
    Console.WriteLine($"Manually: {string.Join(", ", FilterManually(arr, filterMultiple))}");
